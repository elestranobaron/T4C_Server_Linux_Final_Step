			...
			if( 
                (   // If either the attacker or the attacked is on a safe-haven
                    ...
                    Attacker->GetUnderBlock() == __INDOOR_SAFE_HAVEN 
                        ||
                    Attacker->GetUnderBlock() == __BLOCK_ABSOLUTE//BLBLBL : ajout test pour viter que des tricheurs ayant russi  tre sur une case bloquante puisse tuer d'autres joueurs.
                        ||
                    Attacker->GetUnderBlock() == __BLOCK_CAN_FLY_OVER//BLBLBL : ajout test pour viter que des tricheurs ayant russi  tre sur une case bloquante puisse tuer d'autres joueurs.
                        ||
                    Attacker->GetUnderBlock() == __BLOCK_DEEP_WATER//BLBLBL : ajout test pour viter que des tricheurs ayant russi  tre sur une case bloquante puisse tuer d'autres joueurs.
                        ||
                    Attacker->GetUnderBlock() == __BLOCK_SHALLOW_WATER//BLBLBL : ajout test pour viter que des tricheurs ayant russi  tre sur une case bloquante puisse tuer d'autres joueurs.
                        ||
				    Target->GetUnderBlock() == __SAFE_HAVEN
                        ||
                    Target->GetUnderBlock() == __INDOOR_SAFE_HAVEN 
                        ||
                    Target->GetUnderBlock() == __BLOCK_ABSOLUTE//BLBLBL : ajout test pour viter que des tricheurs ayant russi  tre sur une case bloquante puisse tuer d'autres joueurs.
                        ||
                    Target->GetUnderBlock() == __BLOCK_CAN_FLY_OVER//BLBLBL : ajout test pour viter que des tricheurs ayant russi  tre sur une case bloquante puisse tuer d'autres joueurs.
                        ||
                    Target->GetUnderBlock() == __BLOCK_DEEP_WATER//BLBLBL : ajout test pour viter que des tricheurs ayant russi  tre sur une case bloquante puisse tuer d'autres joueurs.
                        ||
                    Target->GetUnderBlock() == __BLOCK_SHALLOW_WATER//BLBLBL : ajout test pour viter que des tricheurs ayant russi  tre sur une case bloquante puisse tuer d'autres joueurs.
                )
                    && 
